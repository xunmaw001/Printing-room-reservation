<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文件名" prop="wenjianming">
          <el-input v-model="ruleForm.wenjianming" 
              placeholder="文件名" clearable  :readonly="ro.wenjianming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文件名" prop="wenjianming">
              <el-input v-model="ruleForm.wenjianming" 
                placeholder="文件名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="双面打印" prop="shuangmiandayin">
          <el-select v-model="ruleForm.shuangmiandayin" placeholder="请选择双面打印">
            <el-option
                v-for="(item,index) in shuangmiandayinOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="双面打印" prop="shuangmiandayin">
	      <el-input v-model="ruleForm.shuangmiandayin"
                placeholder="双面打印" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="取件时间" prop="qujianshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qujianshijian" 
                type="datetime"
                placeholder="取件时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qujianshijian" label="取件时间" prop="qujianshijian">
              <el-input v-model="ruleForm.qujianshijian" 
                placeholder="取件时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="打印要求" prop="dayinyaoqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dayinyaoqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dayinyaoqiu" label="打印要求" prop="dayinyaoqiu">
                    <span v-html="ruleForm.dayinyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dayinyaoqiu = this.ruleForm.dayinyaoqiu.replace(reg,'../../../ssmjto70/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wenjiandayin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wenjiandayinCrossAddOrUpdateFlag = false;
                  this.parent.search();
