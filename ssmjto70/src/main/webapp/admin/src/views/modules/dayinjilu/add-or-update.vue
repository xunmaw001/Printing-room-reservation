<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打印总价" prop="dayinzongjia">
          <el-input v-model="ruleForm.dayinzongjia" 
              placeholder="打印总价" clearable  :readonly="ro.dayinzongjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="打印总价" prop="dayinzongjia">
              <el-input v-model="ruleForm.dayinzongjia" 
                placeholder="打印总价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="打印时间" prop="dayinshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.dayinshijian" 
                type="datetime"
                placeholder="打印时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dayinshijian" label="打印时间" prop="dayinshijian">
              <el-input v-model="ruleForm.dayinshijian" 
                placeholder="打印时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dayinjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dayinjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
