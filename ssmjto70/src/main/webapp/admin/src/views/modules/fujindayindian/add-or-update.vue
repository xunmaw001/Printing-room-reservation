<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打印价格" prop="dayinjiage">
          <el-input v-model="ruleForm.dayinjiage" 
              placeholder="打印价格" clearable  :readonly="ro.dayinjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="打印价格" prop="dayinjiage">
              <el-input v-model="ruleForm.dayinjiage" 
                placeholder="打印价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='dayinjiage'){
            this.ruleForm.dayinjiage = obj[o];
	    this.ro.dayinjiage = true;
            continue;
          }
          if(o=='dizhi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fujindayindian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fujindayindianCrossAddOrUpdateFlag = false;
                  this.parent.search();
